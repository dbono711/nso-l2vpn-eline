...
class Main(Application):
    def setup(self):
        ...
        self.register_service("l2vpn-eline-servicepoint", ServiceCallbacks)
        self.register_action("l2vpn-interface-name", InterfaceCompletion)
